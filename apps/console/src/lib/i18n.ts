  ...
  ru: {
    translation: {
      ...
      databaseQuery: {
        open: "Открыть SQL",
        title: "SQL-запрос",
        description: "Выполните read-only запрос к базе {{databaseName}}",
        sqlLabel: "SQL",
        sqlHint: "Разрешены только read-only запросы: SELECT, WITH, SHOW или EXPLAIN.",
        run: "Выполнить",
        running: "Выполняем…",
  ...
  en: {
    translation: {
      ...
      databaseQuery: {
        open: "Open SQL",
        title: "SQL query",
        description: "Run a read-only query against {{databaseName}}",
        sqlLabel: "SQL",
        sqlHint: "Only read-only statements are allowed: SELECT, WITH, SHOW, or EXPLAIN.",
        run: "Run",
        running: "Running…",
