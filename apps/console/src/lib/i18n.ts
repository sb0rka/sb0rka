  ...
  ru: {
    translation: {
      ...
      dataExplorer: {
        ...
        aiChatInputPlaceholder: "Запрос на человеческом языке…",
        aiChatPromptTitle: "Промпт",
        aiChatFixPromptTitle: "Исправить",
        aiChatAnalysisTitle: "Анализ",
        ...
        aiChatMenuSortByPriceAsc: "Цена по возрастанию",
        aiChatMenuSortByPriceDesc: "Цена по убыванию",
        aiChatMenuGroupReasoning: "Рассуждение",
        aiChatMenuReasoningLevelLow: "Низкое",
        aiChatMenuReasoningLevelMedium: "Среднее",
        aiChatMenuReasoningLevelHigh: "Высокое",
        aiChatMenuGroupThird: "Объяснение",
  ...
  en: {
    translation: {
      ...
      dataExplorer: {
        ...
        aiChatInputPlaceholder: "Ask in natural language…",
        aiChatPromptTitle: "Prompt",
        aiChatFixPromptTitle: "Fix request",
        aiChatAnalysisTitle: "Analysis",
        ...
        aiChatMenuSortByPriceAsc: "Price ascending",
        aiChatMenuSortByPriceDesc: "Price descending",
        aiChatMenuGroupReasoning: "Reasoning",
        aiChatMenuReasoningLevelLow: "Low",
        aiChatMenuReasoningLevelMedium: "Medium",
        aiChatMenuReasoningLevelHigh: "High",
        aiChatMenuGroupThird: "Explanation",
        aiChatMenuPlaceholder: "Coming soon",
        aiChatExplanationStyleMenu: "Explanation",
        styleNone: "None",
