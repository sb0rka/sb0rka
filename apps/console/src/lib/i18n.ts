  ...
  ru: {
    translation: {
      ...
      dataExplorer: {
        ...
        mobileOpen: "Открыть SQL Навигатор",
        mobileSchemaTables: "Таблиц: {{count}}",
        mobileSchemaEmpty: "Схема выбранной базы пока пуста",
        mobileInsertTable: "Вставить {{name}} в SQL",
        mobileAiSubtitle: "Опишите данные, которые нужно получить",
        mobileAiMissingConfig:
          "Для AI-запросов нужны секреты llm_base_url и llm_api_key.",
        mobileAiConfigLoading: "Загружаем конфигурацию AI из секретов…",
        mobileAiConfigError: "Не удалось загрузить конфигурацию AI из секретов.",
        mobileAiEmpty: "Напишите вопрос, и AI предложит SQL для выбранной базы.",
        ...
        aiChatHistory: "История",
        aiChatBookmarks: "Закладки",
        aiChatHistoryDialogTitle: "История SQL",
        aiChatHistoryDescription:
          "Успешно выполненные AI-запросы для выбранной базы данных.",
        aiChatBookmarksDescription:
          "Закладки из истории AI-запросов для выбранной базы данных.",
        aiChatHistoryEmpty: "История для этой базы данных пока пуста.",
        aiChatBookmarksEmpty: "Закладок для этой базы данных пока нет.",
        aiChatHistorySearchPlaceholder: "Поиск по названию или SQL…",
        aiChatHistoryNoResults: "Ничего не найдено по запросу «{{query}}».",
        aiChatBookmarkSql: "Добавить в закладки",
        aiChatUnbookmarkSql: "Убрать из закладок",
        aiChatHeaderMenu: "Меню чата AI",
        aiChatNewQuery: "Новый запрос",
        aiChatInputPlaceholder: "Какие данные вам необходимы?",
        aiChatPromptTitle: "Промпт",
        aiChatFixPromptTitle: "Исправить",
        aiChatThinking: "Думаем…",
        aiChatThinkingTitle: "Рассуждение",
        aiChatThinkingExpand: "Развернуть",
        aiChatThinkingCollapse: "Свернуть",
        aiChatSend: "Отправить",
        aiChatStop: "Остановить",
        aiChatErrorTitle: "Запрос не выполнен",
        aiChatMenuGroupModel: "Модель",
        aiChatMenuModelsLoading: "Загружаем модели…",
        aiChatMenuModelsFallback: "Не удалось загрузить каталог, показываем резервный список",
        aiChatMenuModelsEmpty: "Нет доступных моделей",
        aiChatMenuModelsNotFound: "По фильтру ничего не найдено",
        aiChatMenuFilterModels: "Фильтр моделей…",
        aiChatMenuClearFilter: "Очистить фильтр",
        aiChatMenuSortLabel: "Сортировка",
        aiChatMenuRefreshModels: "Обновить модели",
        aiChatMenuSortByName: "По имени",
        aiChatMenuSortById: "По порядку",
        aiChatMenuSortByPriceAsc: "Цена входа по возрастанию",
        aiChatMenuSortByPriceDesc: "Цена входа по убыванию",
        aiChatMenuPriceColumnName: "имя",
        aiChatMenuPriceColumnIn: "вх",
        aiChatMenuPriceColumnInTitle: "Цена входных токенов (µ$ за токен)",
        aiChatMenuPriceColumnOut: "вых",
        aiChatMenuPriceColumnOutTitle: "Цена выходных токенов (µ$ за токен)",
        aiChatMenuPricingInput: "Вход (prompt): {{value}} / 1M ток.",
        aiChatMenuPricingOutput: "Выход (completion): {{value}} / 1M ток.",
        aiChatMenuPricingCacheRead: "Кэш входа: {{value}} / 1M ток.",
        aiChatMenuPricingVariable: "Цена входа зависит от выбранной модели",
        aiChatUsageTitle: "Использование токенов и стоимость запроса",
        aiChatMenuPlaceholder: "Скоро будет доступно",
        fix: "Исправить",
        fixing: "Исправляем…",
        fixChatSqlLabel: "SQL",
        fixChatErrorLabel: "Ошибка",
        fixDiagnosisTitle: "Разбор",
        aiChatFixedSql: "Исправленный SQL",
      },
      secrets: {
        title: "Секреты",
        ...
        nameExample: "Например: LLM_API_KEY",
  ...
  en: {
    translation: {
      ...
      dataExplorer: {
        ...
        mobileOpen: "Open SQL Explorer",
        mobileSchemaTables: "Tables: {{count}}",
        mobileSchemaEmpty: "The selected database schema is empty",
        mobileInsertTable: "Insert {{name}} into SQL",
        mobileAiSubtitle: "Describe the data you need",
        mobileAiMissingConfig:
          "AI queries require llm_base_url and llm_api_key secrets.",
        mobileAiConfigLoading: "Loading AI configuration from secrets…",
        mobileAiConfigError: "Unable to load AI configuration from secrets.",
        mobileAiEmpty: "Ask a question and AI will suggest SQL for the selected database.",
        ...
        aiChatBookmarks: "Bookmarks",
        aiChatHistoryDialogTitle: "SQL history",
        aiChatHistoryDescription:
          "Successfully run AI queries for the selected database.",
        aiChatBookmarksDescription:
          "Bookmarked AI query history for the selected database.",
        aiChatHistoryEmpty: "No history for this database yet.",
        aiChatBookmarksEmpty: "No bookmarks for this database yet.",
        aiChatHistorySearchPlaceholder: "Search title or SQL…",
        aiChatHistoryNoResults: "No results for «{{query}}».",
        aiChatBookmarkSql: "Bookmark SQL",
        aiChatUnbookmarkSql: "Remove SQL bookmark",
        aiChatHeaderMenu: "AI chat menu",
        aiChatNewQuery: "New Query",
        aiChatInputPlaceholder: "What data do you need?",
        aiChatPromptTitle: "Prompt",
        aiChatFixPromptTitle: "Fix request",
        aiChatThinking: "Thinking…",
        aiChatThinkingTitle: "Reasoning",
        aiChatThinkingExpand: "Show more",
        aiChatThinkingCollapse: "Show less",
        aiChatSend: "Send",
        aiChatStop: "Stop",
        aiChatErrorTitle: "Request failed",
        aiChatMenuGroupModel: "Model",
        aiChatMenuModelsLoading: "Loading models…",
        aiChatMenuModelsFallback: "Unable to load catalog, showing fallback models",
        aiChatMenuModelsEmpty: "No models available",
        aiChatMenuModelsNotFound: "No models match the filter",
        aiChatMenuFilterModels: "Filter models…",
        aiChatMenuClearFilter: "Clear filter",
        aiChatMenuSortLabel: "Sort",
        aiChatMenuRefreshModels: "Refresh models",
        aiChatMenuSortByName: "Name",
        aiChatMenuSortById: "Default order",
        aiChatMenuSortByPriceAsc: "Input price ascending",
        aiChatMenuSortByPriceDesc: "Input price descending",
        aiChatMenuPriceColumnName: "name",
        aiChatMenuPriceColumnIn: "in",
        aiChatMenuPriceColumnInTitle: "Input token price (µ$ per token)",
        aiChatMenuPriceColumnOut: "out",
        aiChatMenuPriceColumnOutTitle: "Output token price (µ$ per token)",
        aiChatMenuPricingInput: "Input (prompt): {{value}} / 1M tokens",
        aiChatMenuPricingOutput: "Output (completion): {{value}} / 1M tokens",
        aiChatMenuPricingCacheRead: "Input cache read: {{value}} / 1M tokens",
        aiChatMenuPricingVariable: "Input price varies by routed model",
        aiChatUsageTitle: "Token usage and request cost",
        aiChatMenuPlaceholder: "Coming soon",
        fix: "Fix",
        fixing: "Fixing…",
        fixChatSqlLabel: "SQL",
        fixChatErrorLabel: "Error",
        fixDiagnosisTitle: "Diagnosis",
        aiChatFixedSql: "Fixed SQL",
      },
      secrets: {
        title: "Secrets",
        ...
        nameExample: "Example: LLM_API_KEY",
