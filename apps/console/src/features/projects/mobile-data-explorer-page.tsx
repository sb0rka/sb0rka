                ...
                <li key={key}>
                  <div className="flex items-center gap-2 px-3 py-3">
                    ...
                    <Button
                      ...
                      onClick={() => onInsertSql(displayName)}
                      aria-label={t("dataExplorer.mobileInsertTable", { name: displayName })}
                    >
                  ...
                  {isOpen ? (
                    <ul className="space-y-1 bg-muted/30 px-3 pb-3">
                      {table.columns.map((column) => (
                        ...
                        >
                          ...
                          >
                            <span className="block truncate text-sm font-medium">{column.name}</span>
