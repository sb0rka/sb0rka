...
Access permissions and the session model are described in [Authentication & access](authentication). Service overview — see [Overview](overview).

Regenerate the spec after changing annotations: `swag init` (see `.claude/commands/regen-swagger.md`).
