...
1. Установка — Используйте `go install github.com/sb0rka/sb0rka/apps/s0c@latest` (требуется Go) или скачайте готовый бинарный файл из раздела [Releases на GitHub](https://github.com/sb0rka/sb0rka/releases).

2. Аутентификация — Выполните `s0c auth login` и войдите, используя ваши учетные данные Sb0rka.

3. Создание первой базы данных — Выполните `s0c psql`, чтобы автоматически создать проект и базу данных (если у вас их еще нет), после чего откроется сессия `psql`.
